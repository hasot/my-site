function ShineyLights() {
    let FSS = (function (window) {
        ...
        (FSS = {
            ...
            (FSS.Color.prototype = {
                ...
                hexify: function (t) {
                    let e = Math.ceil(255 * t).toString(16);
            ...
            (FSS.WebGLRenderer.prototype.setBufferData = function (t, e, i) {
                if (FSS.Utils.isNumber(i)) e.data[t * e.size] = i;
                    ...
                    for (let r = i.length - 1; r >= 0; r--) e.data[t * e.size + r] = i[r];
            }),
    ...
    let container, output, animateId;
